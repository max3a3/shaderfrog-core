...
// import { uniformStrategy } from '@core/strategy';  todo fix @core
import { uniformStrategy } from '../src/strategy';
import { NodePosition, sourceNode, numberUniformData } from '../src/graph';
...
float multiplicationFactor = 10.0;
